...
import os
import shutil
from vlm_cytomorphology_eval.config.dataset_info_and_paths import get_global_info, get_dataset_info, get_fine_tuning_subset_paths


def import_model(model_family):
    if 'gpt' in model_family:
        from vlm_cytomorphology_eval.models.gpt_api import gpt_api_finetuning_entry
